...
nsv-sector-monitor-starmap-title = Strategic starmap
nsv-sector-monitor-node-none = No node selected
nsv-sector-monitor-node-selected = Node { $id }: { $state }
nsv-sector-monitor-node-data-only = Data-only (no sector)
nsv-sector-monitor-node-residents = Resident data fleets
nsv-sector-monitor-spawn-fleet = Spawn data fleet (kestrel) here
nsv-sector-monitor-fleets = Data fleets
nsv-sector-monitor-fleet-entry = { $id } [{ $state }] @ { $node } — { $completeness }%
nsv-sector-monitor-move-target-none = Select a fleet and a node to move
nsv-sector-monitor-move-target = Move { $ship } to { $node }
nsv-sector-monitor-move-fleet = Move selected fleet to node
